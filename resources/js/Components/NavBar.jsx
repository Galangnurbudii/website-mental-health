    ...
    return (
        <div className="relative z-10 flex justify-between items-center h-20 max-w-screen mx-auto px-6 md:px-16 text-putih">
            ...
            <ul className="hidden md:flex">
                <li className="p-4 text-hitam md:text-lg hover:text-primary hover:font-semibold">
                    <Link href={route('home')}>Beranda</Link>
                </li>
                <li className="p-4 text-hitam md:text-lg font-medium hover:text-primary hover:font-semibold">
