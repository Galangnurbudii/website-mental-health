...
export default function Cards({ className = '', disabled, ...props }){
    return(
        <div className='grid mx-auto gap-6 pb-10 
                    md:grid-cols-2 
                    sm:grid-cols-1 
                    lg:grid-cols-3
                    px-10
                    md:px-20
                    lg:px-44'>
                        <div className="card w-100 h-[540px] bg-base-100 shadow-xl border border-gray-300">
                        ...
                        <div className="card w-100 h-[540px] bg-base-100 shadow-xl border border-gray-300">
                            <figure className='bg-counselingBackground'><img src="images/CaraKonseling2.jpg"/></figure>
                            <div className="card-body">
                                <div className='flex flex-cols-2'>
                                    <div className='pr-4'>
                                        <NumberBox number={2}/>
                        ...
                        <div className="card w-100 h-[540px] bg-base-100 shadow-xl border border-gray-300">
                            <figure className='bg-counselingBackground'><img src="images/CaraKonseling3.png"/></figure>
                            <div className="card-body">
                                <div className='flex flex-cols-2'>
                                    <div className='pr-4'>
                                        <NumberBox number={3}/>
