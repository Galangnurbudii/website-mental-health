        ...
        >
            ...
            <div className="flex sm:items-center pb-10">
                <div className="w-full shadow-xl border bg-white mx-auto my-auto rounded-lg">
                    <figure className="px-6 sm:px-8 md:px-8 lg:px-8 py-5 flex justify-center">
                        <img src="storage/images/detailPsikolog.jpg" alt="" />
                    </figure>
                    <div className="pl-6 sm:pl-8 md:pl-8 lg:pl-8 pb-4">
                        <h2 className="font-bold text-xl pb-0">
                            Nathalia Chandra
                        </h2>
                    ...
                    {/* Price */}
                    <h1 className="pl-6 sm:pl-8 md:pl-8 lg:pl-8 py-2 card-title text-md font-bold bg-disabledBackground">
                        Rp 200.000
                    </h1>

                    {/* Bidang Keahlian */}
                    <p className="text-disabled font-bold pl-8 pt-4 pb-2">
                        Bidang Keahlian
                    </p>
                    ...
                    <div className="px-6 sm:px-8 md:px-8 lg:px-8  flex items-start">
                        <img
                            className="pt-2"
                            src="storage/images/nstk.jpg"
                            width={24}
                        />
                        <div>
                            <h1 className="pl-3 font-bold">
                                Nomor Surat Tanda Registrasi
                            </h1>
                            <p className="pl-3 pb-3 text-xs">
                                3321601321068534
                            </p>
                        </div>
                    </div>
