...
const NavProfil = () => {
    ...
    const Menus = [
        { title: 'Beranda', icon: BiHomeAlt2 },
        { title: 'Edit Profil', icon: AiOutlineUser },
        { title: 'List Konsultasi', icon: HiOutlineShoppingCart },
        { title: 'Hapus Akun', icon: BiTrashAlt, gap: true },
