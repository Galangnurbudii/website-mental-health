...
function ProfileNavbar() {
    return (
        <div className=" flex items-end justify-end px-4 pb-6">
            ...
            <div className="z-20 fixed top-0 -left-96 lg:left-0 h-screen w-7/12  md:w-60 lg:w-72 bg-primary shadow-2xl peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
                <nav role="navigation" className="p-6">
                    <div className="flex items-center gap-4 pb-4">
                        <h1 className="text-putih font-bold text-2xl md:text-3xl">
                            Berani Bicara
                        </h1>
                    </div>
                    ...
                    <div className="mt-4 -mx-4 relative overflow-y-auto overflow-x-hidden h-1/2">
                        <ul className="space-y-8 mb-12 px-4 mt-8">
                            <li>
                                <a
                                    href={route('home')}
                                    className="flex gap-4 p-2 text-putih hover:text-primary transition font-medium text-base md:text-lg hover:bg-putih hover:p-2 hover:rounded-md"
                                >
                                    <BiHomeAlt2 size={25} />
                                    Beranda
                                </a>
