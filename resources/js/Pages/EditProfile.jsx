...
export default function EditProfile(props) {
    ...
    const { data, setData, put, errors } = useForm({
        ...
        rating: users.rating || '',
        bidang_keahlian: users.bidang_keahlian || '',
        tahun_pengalaman: users.tahun_pengalaman || '',
        nomor_str: users.nomor_str || '',
        lokasi_praktik: users.lokasi_praktik || '',
        lulusan: users.lulusan || '',
    })
