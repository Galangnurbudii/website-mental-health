    ...
    <>
        ...
        <div className='ml-36 mb-8'>
            <h1 className='text-primary text-3xl font-bold'>
                SYARAT DAN KETENTUAN PENGGUNA BERANI BICARA
            </h1>
        </div>
        <div className='py-12 px-14 mb-[50px] mx-36 border border-gray-200 shadow-md shadow-gray-300 rounded-lg flex flex-col'>
            <div className='flex flex-col text-center'>
                <span>
                    SYARAT DAN KETENTUAN PENGGUNAAN<br />
                    BERANI BICARA<br /><br />
                    (Terakhir diperbarui tanggal: 6 Maret 2023)
                </span>
            </div>
            <br />
            <span>
                MOHON UNTUK MEMBACA SELURUH SYARAT DAN KETENTUAN PENGGUNAAN SERTA KEBIJAKAN PRIVASI BERANI BICARA DENGAN CERMAT DAN SAKSAMA SEBELUM MENGGUNAKAN SETIAP FITUR DAN/ATAU LAYANAN YANG TERSEDIA DALAM PLATFORM BERANI BICARA.
                <br />
                <br />

                Syarat dan Ketentuan Penggunaan Berani Bicara (“Ketentuan Penggunaan”) ini merupakan suatu perjanjian sah terkait tata cara dan persyaratan penggunaan fitur dan/atau layanan (“Layanan”) Platform Berani Bicara (“Platform”) antara Pengguna (“Anda”) dengan pengelola Platform, yaitu PT Media Psikolog Investama (“Kami”). Dengan mengunduh dan/atau memasang dan/atau menggunakan Platform dan/atau menikmati Layanan Kami, Anda setuju bahwa Anda telah membaca, memahami, mengetahui, menerima, dan menyetujui seluruh informasi, syarat-syarat, dan ketentuan-ketentuan penggunaan Platform yang terdapat dalam Ketentuan Penggunaan ini. 
                <br />
                <br />
                ...
                <br />
                c. Platform berfungsi sebagai sarana untuk menghubungkan Anda dengan pihak ketiga yang menyediakan layanan Psikolog kepada Anda.
                <br />
                d. Jenis-jenis layanan yang dapat diakses dan digunakan melalui Platform adalah:
                <br />
                (i) Chat dan atau video call dengan Psikolog;
                <br />
                (ii) Janji temu dengan Psikolog.
                <br />
                ...
                <br />
                f. Kami dapat menggunakan jasa pihak ketiga terkait penyediaan layanan pembayaran. Apabila terjadi kegagalan pada sistem pembayaran, Kami akan berupaya semaksimal mungkin dalam membantu menyelesaikan masalah yang mungkin timbul. Penyedia jasa perbankan/pembayaran yang dipilih oleh Anda dapat mengenakan biaya tambahan kepada Anda atas layanan yang diberikan.
                <br />
                g. Setiap fitur atau fasilitas dalam Platform dapat diperbarui atau diubah sesuai dengan kebutuhan dan perkembangan Platform.
                <br />
                h. Pengumpulan, penyimpanan, pengolahan, penggunaan dan pembagian setiap informasi pribadi Anda, seperti nama, alamat surat elektronik, dan nomor telepon genggam Anda yang Anda berikan ketika Anda membuka akun di Platform, maupun setiap informasi terkait riwayat kesehatan Anda tunduk pada Kebijakan Privasi, yang merupakan bagian yang tidak terpisahkan dari Ketentuan Penggunaan ini. Anda memahami dan setuju bahwa penggunaan Anda atas Platform juga harus mematuhi Kebijakan Privasi Kami, sebagaimana dapat diperbaharui dari waktu ke waktu.  
                <br />
                i. Kami dapat menghentikan atau membatasi proses registrasi atau penggunaan Platform oleh Anda jika ditemukan pelanggaran dari Ketentuan Penggunaan ini atau peraturan perundang-undangan yang berlaku.
                <br />
                j. Kami adalah perusahaan teknologi, bukan penyedia layanan kesehatan, dan Kami tidak menyediakan layanan kesehatan. Kami tidak mempekerjakan Penyedia Layanan, dan Kami tidak bertanggung jawab atas tindakan, kecerobohan, kelalaian, dan/atau kelengahan Penyedia Layanan. Platform merupakan layanan informasi dan komunikasi online yang disediakan oleh Berani Bicara.
                <br />
                <br />

                2. KETENTUAN PENGGUNAAN PLATFORM
                <br />
                a. Anda dapat menggunakan Platform dengan terlebih dahulu melakukan pendaftaran yang disertai pemberian informasi data pribadi Anda yang dapat dipertanggung jawabkan secara hukum sebagaimana diminta dalam Platform (“Data Pribadi”). Informasi terkait Data Pribadi yang diberikan hanya akan digunakan oleh Kami dan/atau Penyedia Layanan untuk pemberian layanan-layanan dalam Platform dan untuk tujuan lain yang telah Anda setujui sesuai dengan ketentuan perundang-undangan yang berlaku. Kebijakan Privasi (sebagaimana diperbarui dari waktu ke waktu) menjadi bagian yang tidak terpisahkan dari Ketentuan Penggunaan ini. 
                <br />
                b. Setelah mendaftarkan diri pada Platform, Anda akan mendapatkan suatu akun pribadi yang dapat diakses dengan One Time Password (OTP) yang akan dikirimkan ke nomor telepon seluler Anda. Kami harap Anda tidak menyerahkan, mengalihkan maupun memberikan wewenang kepada orang lain untuk menggunakan identitas atau menggunakan akun Anda. Anda wajib menjaga kerahasiaan kata sandi akun Anda dan setiap identifikasi yang kami berikan kepada Anda atas akun atau Data Pribadi Anda. 
                <br />
                c. Anda memiliki tanggung jawab atas setiap penggunaan akun Anda dalam Platform. Apabila Anda tidak memiliki kontrol atas akun Anda oleh sebab apapun, maka Anda diharuskan untuk melaporkannya kepada Kami. Apabila terjadi penyalahgunaan akun Anda oleh pihak ketiga manapun sebelum pelaporan terjadi, maka penggunaan akun pada periode tersebut akan menjadi tanggung jawab Anda sepenuhnya.
                <br />
                d. Anda tidak diperkenankan untuk membahayakan, menyalahgunakan, mengubah atau memodifikasi Platform dengan cara apapun. Kami dapat menutup, membatalkan akun Anda dan/atau melarang Anda untuk menggunakan Platform lebih lanjut jika Anda tidak mematuhi Ketentuan Penggunaan ini. 
                <br />
                e. Dengan menggunakan Platform, maka Anda memahami, setuju, dan tunduk sesuai yang dipersyaratkan pada Kebijakan Privasi Kami sebagaimana dapat diperbaharui dari waktu ke waktu. 
                <br />
                f. Anda akan menggunakan Platform hanya untuk tujuan mendapatkan Layanan, dan tidak akan menyalahgunakan atau menggunakan Platform untuk aktivitas yang bertentangan dengan hukum, termasuk namun tidak terbatas kepada tindak pidana pencucian uang, pencurian, penggelapan, terorisme maupun penipuan. Anda juga sepakat bahwa Anda tidak akan melakukan pemesanan palsu melalui Platform dan tidak akan melakukan perbuatan melawan hukum melalui Platform.
                <br />
                g. Anda mengetahui dan setuju bahwa setiap informasi dalam bentuk apapun, termasuk namun tidak terbatas pada video, audio, gambar atau tulisan yang ada dalam Platform memiliki hak atas kekayaan intelektual (termasuk namun tidak terbatas kepada hak atas merek dan hak cipta) masing-masing. Anda tidak diperbolehkan untuk menggunakan, mengubah, memfasilitasi, menyebarluaskan dan/atau memutilasi hak atas kekayaan intelektual tersebut tanpa izin dari pemilik hak atas kekayaan intelektual tersebut sebagaimana diatur dalam peraturan perundang-undangan yang berlaku.
                <br />
                h. Pada saat mengakses dan menggunakan Platform termasuk setiap fitur dan layanannya, Anda tidak diperkenankan untuk:
                <br />
                ...
                3. LAYANAN
                <br />
                (i) Fitur ini memfasilitasi para psikolog, psikolog, dan/atau psikolog klinis rekanan Kami sebagai Penyedia Layanan untuk berinteraksi dengan Anda melalui video call, voice call maupun chat yang dapat diakses melalui Platform.
                <br />
                (ii) Anda dapat menghubungi para psikolog, psikolog, dan/atau psikolog klinis rekanan Kami ketika para psikolog, psikolog, dan/atau psikolog klinis rekanan Kami berstatus online. 
                <br />
                (iii) Jika Anda tidak hadir pada jadwal booking yang telah Anda pilih maka Anda menyetujui bahwa dana yang telah Anda bayarkan tidak dapat dikembalikan. 
                <br />
                (iv) Jika psikolog, psikolog, atau psikolog klinis rekanan Kami tidak hadir pada jadwal booking yang telah Anda buat dalam waktu maksimal 5 (lima) menit setelah jadwal yang seharusnya maka Kami akan mengembalikan dana Anda sesuai dengan prosedur yang berlaku.
                <br />
                (v) Kami akan mengirimkan pemberitahuan terkait janji Chat dan atau tatap muka langsung dengan Psikolog melalui push notification pada perangkat elektronik Anda. Untuk dapat menerima push notification yang Kami kirimkan maka Anda harus mengaktifkan push notification tersebut.
                <br />
                (vi) Anda mengetahui dan menyetujui bahwa fitur ini tidak menggantikan pemeriksaan dengan psikolog pada umumnya atau tatap muka secara langsung. 
                <br />
                (vii) Kami akan berupaya semaksimal mungkin agar psikolog rekanan yang terdaftar pada Platform dapat memberikan tanggapan atas pertanyaan Anda sesegera mungkin. Namun demikian, Kami tidak menyarankan Anda menggunakan Platform untuk kondisi medis darurat.
                <br />
                (viii) Layanan Kami tidak bersifat memaksa atau pun mengikat. Keputusan untuk menggunakan Layanan di Platform sepenuhnya berada di tangan Anda. Platform hanya merupakan fasilitator interaksi antara psikolog rekanan yang terdaftar pada Kami sebagai Penyedia Layanan.
                <br />
                (ix) Anda memahami bahwa Anda perlu memberikan informasi dan menjelaskan gejala atau keluhan fisik yang Anda alami secara lengkap, jelas dan akurat ketika melakukan percakapan dengan psikolog rekanan Kami melalui fitur Chat dan atau tatap muka langsung dengan Psikolog.
                <br />
                <br />

                4. TRANSAKSI ANDA
                <br />
                (a) Untuk dapat bertransaksi di Platform, Anda dapat menggunakan berbagai metode pembayaran yang tersedia pada Platform.
                <br />
                ...
                <br />
                (c) Kami dapat melakukan penangguhan segala transaksi yang berasal dari akun Anda serta dapat melakukan tindakan penangguhan transaksi apabila kami mengidentifikasi adanya masalah pada akun Anda atau suatu transaksi tertentu.
                <br />
                <br />

                5. KETENTUAN TRANSAKSI
                <br />
                (i) Anda akan dikenakan tarif dengan jumlah tertentu untuk dapat menggunakan layanan Chat dengan psikolog rekanan Kami.
                Apabila Anda memerlukan video call maupun voice call dengan psikolog rekanan Kami, Anda perlu menginformasikan terlebih dahulu kepada psikolog rekanan tersebut dan akan tergantung pada ketersediaan masing-masing psikolog pada saat dihubungi.
                <br />
                (ii) Psikolog dapat melakukan Follow Up kepada Anda untuk mengecek kondisi kesehatan Anda setelah dilakukannya sesi Chat dengan Psikolog.
                <br />
                (iii) Transaksi tidak dapat dibatalkan setelah sesi Chat dengan Psikolog berakhir atau selesai dilakukan.
                <br />
                (iv) Kami dapat memblokir atau membatalkan akun Anda apabila terdapat penyalahgunaan fitur Chat dengan Psikolog pada akun Anda.
                <br />
                (v) Psikolog dapat memberikan Psikolog Referral (Rujukan Psikolog) sebagai referensi Anda. 
                <br />
                (vi) Biaya yang dikenakan tersebut sudah termasuk Pajak Pertambahan Nilai (PPN).
                <br />
                (vii) Ketepatan serta keakuratan Psikolog dalam memberikan Medicine Recommendation (Rekomendasi Obat) akan bergantung pada informasi yang diberikan oleh Anda. Setiap isi dan/atau pernyataan-pernyataan dalam percakapan yang dilakukan oleh Anda dengan Psikolog menggunakan fitur video call, voice call, chat, Psikolog Notes (Catatan Psikolog), Medicine Recommendation (Rekomendasi Obat), pada Platform, hal tersebut ialah percakapan dan interaksi pribadi antara Anda dengan Psikolog rekanan sebagai pemberi jasa layanan kesehatan. 
                <br />
                <br />

                6. PENGGUNAAN KODE KUPON
                <br />
                a. Dengan menggunakan kode kupon, Anda setuju untuk terikat dengan syarat dan ketentuan mengenai penggunaan kode kupon.
                <br />
                b. Kode kupon tidak dapat dialihkan dan tidak dapat ditukar dalam bentuk uang.
                <br />
                c. Potongan harga yang terdapat dalam kode kupon tidak dapat diklaim dan/atau diubah setelah pembelian dan pembayaran telah dikonfirmasi oleh Kami.
                <br />
                d. Masing - masing kode kupon berlaku untuk periode tertentu. Silakan memeriksa masing - masing kupon yang Anda terima untuk memastikan masa berlaku kode kupon Anda.
                <br />
                e. Kami berhak untuk menghentikan kode kupon sewaktu - waktu berdasarkan kebijakan mutlak Kami.
                <br />
                f. Kami berhak, tanpa pemberitahuan sebelumnya, membatalkan penggunaan kupon oleh Anda jika ditemukan indikasi kecurangan atau pelanggaran yang dilakukan oleh Anda atas Ketentuan Penggunaan ini dan ketentuan hukum yang berlaku di wilayah Negara Republik Indonesia. Atas pembatalan tersebut, Kami tidak akan memberikan ganti rugi dalam bentuk apa pun.
                <br />
                <br />

                7. HAK ATAS KEKAYAAN INTELEKTUAL
                <br />
                a. Kami adalah pemegang hak lisensi atas nama, ikon, dan logo “Berani Bicara” serta fitur Chat dengan Psikolog dan Tes Lab dalam Platform, yang mana merupakan hak cipta dan merek dagang yang dilindungi undang-undang Republik Indonesia. Anda dilarang untuk menggunakan, memodifikasi, dan/atau memasang nama, ikon, logo, atau merek tersebut tanpa persetujuan tertulis dari Kami. 
                <br />
                ...
                <br />
                PT Media Psikolog Investama
                <br />
                Jl. H.R. Rasuna Said Kav B32-33, Jakarta Selatan
                <br />
                help@beranibicara.com / 021-1012-2043
                <br />
                <br />
                ...
                <br />
                b. Anda dapat menghapus profil yang dibuat di bawah akun Anda dengan mengakses langsung pada setiap profil yang ingin Anda hapus.
                <br />
                c. Dalam hal penghapusan profil sebagaimana dimaksud pada poin 13(b) di atas, tergantung pada alasan penghapusan yang Anda pilih, informasi dan data yang terdapat pada profil yang dihapus akan:
                <br />
                ...
                <br />
                (iv) Kami mengetahui atau dengan alasan yang cukup menduga bahwa telah terjadi hal-hal yang menurut pandangan Kami telah atau dapat merugikan Kami, Anda, Penyedia Layanan atau pihak lainnya; 
                <br />
                ...
                <br />
                (viii) Penggunaan Platform atau Layanan oleh Anda atau pihak lain (yang menggunakan akun Anda) dengan cara yang bertentangan dengan Ketentuan Penggunaan ini, Kebijakan Privasi atau peraturan perundang-undangan yang berlaku; dan/atau 
                <br />
                (ix) Perintah untuk pembekuan akun, baik sementara atau permanen, yang diterbitkan oleh institusi pemerintah atau moneter terkait atau berdasarkan perintah pengadilan yang diterbitkan sesuai dengan peraturan perundang-undangan yang berlaku.
                <br />
                <br />
