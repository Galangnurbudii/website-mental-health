      ...
      <div className='lg:pl-96 md:px-40 px-10 py-16'>
        ...
        <div className='grid grid-cols-0'>
            ...
            <div className='grid grid-cols-2 pb-5'>
                ...
                <div className='flex'>
                    <h3 className='font-semibold pr-1'>:</h3>
                    <h3 className='pr-20 font-medium'> Gangguan mood, Depresi, Cemas</h3>
                </div>                
            </div>  
            <div className='grid grid-cols-2 pb-5'>
            <h3 className='font-semibold'>Nomor Surat Tanda Registrasi</h3>
                <div className='flex'>
                    <h3 className='font-semibold pr-1'>:</h3>
            ...
            <div className='grid grid-cols-2 pb-5'>
                ...
                <div className='flex'>
                    <h3 className='font-semibold pr-1'>:</h3>
                    <h3 className='pr-20 font-medium'>Klinik Sehat Medika, Denpasar Bali</h3>
                </div>
            </div>  
            <div className='grid grid-cols-2 pb-5'>
                <h3 className='font-semibold'>Hari/Tanggal Konsultasi</h3>
                <div className='flex'>
                    <h3 className='font-semibold pr-1'>:</h3>
                    <h3 className='pr-20 font-medium'>Senin, 18 Juli 2023</h3>
                </div>
            </div>  
            <div className='grid grid-cols-2 pb-5'>
