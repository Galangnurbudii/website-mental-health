...
export default function DetailLayanan({ psikologs }) {
                                        ...
                                        <div className="pt-5 p-5">
                                            ...
                                            <div>
                                                ...
                                                <div className="py-4 pl-1 flex flex-row gap-2 shrink overflow-x-auto">
                                                    <button
                                                        type="button"
                                                        class="inline-flex items-center px-4 py-1 border border-[#d8dbe1] text-sm text-center text-disabled font-semibold bg-white rounded-lg hover:bg-gray-300 focus:ring-2 focus:outline-none focus:ring-blue-300"
                                                    >
                                                        12:00
                                                    </button>
                                                    <button
